...
export function ArticlesSolidIcon(props) {
  return (
    <IconBase {...props}>
      <path d="M5.5 3.25A2.25 2.25 0 0 0 3.25 5.5v13A2.25 2.25 0 0 0 5.5 20.75h13A2.25 2.25 0 0 0 20.75 18.5V9.44a2.25 2.25 0 0 0-.66-1.59l-3.94-3.94a2.25 2.25 0 0 0-1.59-.66H5.5Z" />
      <path d="M14.75 3.25V7.5A1.25 1.25 0 0 0 16 8.75h4.75" opacity="0.3" />
      <path d="M7.75 11c0-.41.34-.75.75-.75h7a.75.75 0 0 1 0 1.5h-7a.75.75 0 0 1-.75-.75Zm0 3.75c0-.41.34-.75.75-.75h7a.75.75 0 0 1 0 1.5h-7a.75.75 0 0 1-.75-.75Zm0 3.75c0-.41.34-.75.75-.75H13a.75.75 0 0 1 0 1.5H8.5a.75.75 0 0 1-.75-.75Z" />
    </IconBase>
  );
}
...
export function CoursesSolidIcon(props) {
  return (
    <IconBase {...props}>
      <path d="M12 3.1 2.95 7.27a.75.75 0 0 0 0 1.36L12 12.8l9.05-4.17a.75.75 0 0 0 0-1.36L12 3.1Z" />
      <path d="M6 10.55v4.2c0 .84.48 1.61 1.24 1.97l3.76 1.78c.63.3 1.37.3 2 0l3.76-1.78A2.2 2.2 0 0 0 18 14.75v-4.2L12.31 13.2a.75.75 0 0 1-.62 0L6 10.55Z" opacity="0.92" />
      <path d="M19.5 9.6v5.15a.75.75 0 0 0 1.5 0V8.9l-1.5.7Z" opacity="0.42" />
    </IconBase>
  );
}
