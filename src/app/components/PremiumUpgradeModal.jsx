...
const PremiumUpgradeModal = ({
  ...
  const sections = useMemo(
    () => [
      ...
      {
        key: "blogs",
        title: t("premiumModal.sections.blogs.title"),
        description: t("premiumModal.sections.blogs.description"),
        items: [
          {
            label: t("premiumModal.items.blogsPerUser"),
            ordinary: APP_LIMITS.blogsPerUser.ordinary,
            premium: APP_LIMITS.blogsPerUser.premium,
          },
          {
            label: t("premiumModal.items.blogCommentsPerBlog"),
            ordinary: APP_LIMITS.blogCommentsPerBlog.ordinary,
            premium: APP_LIMITS.blogCommentsPerBlog.premium,
          },
          {
            label: t("premiumModal.items.blogImagesPerBlog"),
            ordinary: APP_LIMITS.blogImagesPerBlog.ordinary,
            premium: APP_LIMITS.blogImagesPerBlog.premium,
          },
          {
            label: t("premiumModal.items.blogWords"),
            ordinary: formatWords(t, APP_LIMITS.blogWords.ordinary),
            premium: formatWords(t, APP_LIMITS.blogWords.premium),
          },
          {
            label: t("premiumModal.items.blogTitleChars"),
            ordinary: formatChars(t, APP_LIMITS.blogTitleChars),
            premium: formatChars(t, APP_LIMITS.blogTitleChars),
          },
          {
            label: t("premiumModal.items.blogExcerptChars"),
            ordinary: formatChars(t, APP_LIMITS.blogExcerptChars),
            premium: formatChars(t, APP_LIMITS.blogExcerptChars),
          },
          {
            label: t("premiumModal.items.blogTagChars"),
            ordinary: `${APP_LIMITS.blogTagCount} × ${formatChars(t, APP_LIMITS.blogTagChars)}`,
            premium: `${APP_LIMITS.blogTagCount} × ${formatChars(t, APP_LIMITS.blogTagChars)}`,
          },
          {
            label: t("premiumModal.items.blogCommentChars"),
            ordinary: formatChars(t, APP_LIMITS.blogCommentChars),
            premium: formatChars(t, APP_LIMITS.blogCommentChars),
          },
        ],
      },
      {
