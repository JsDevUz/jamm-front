    ...
    <Overlay onClick={onClose}>
      <Card onClick={(event) => event.stopPropagation()}>
        ...
        <Body>
          ...
          <Group>
            <Label>{t("arenaShared.shareLinks.persistLabel")}</Label>
            <Segmented>
              <SegmentButton
                type="button"
                $active={mode === "persist"}
          ...
          <Group>
            <Label>{t("arenaShared.shareLinks.showResults")}</Label>
            <Segmented>
              <SegmentButton
                type="button"
                $active={showResults}
          ...
          <Group>
            <Label>{t("arenaShared.shareLinks.timeLimit")}</Label>
            <Input
              type="number"
              min="0"
          ...
          <Group>
            <Label>{t("arenaShared.shareLinks.previousLinks")}</Label>
            {loadingLinks ? (
