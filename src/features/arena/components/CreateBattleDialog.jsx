  ...
  return (
    <Overlay onClick={onClose}>
      <Content onClick={(e) => e.stopPropagation()}>
        <Header>
          <h2>{t("arenaShared.createBattle.title")}</h2>
        ...
        <Section>
          <Label>{t("arenaShared.createBattle.name")}</Label>
          <Input
            placeholder={t("arenaShared.createBattle.namePlaceholder")}
            value={roomName}
        ...
        <Section>
          <Label>{t("arenaShared.createBattle.testLabel")}</Label>
          <Select
            value={selectedTestId}
            onChange={(e) => setSelectedTestId(e.target.value)}
          >
            <option value="">
              {t("arenaShared.createBattle.testPlaceholder")}
            </option>
            {myTests.map((t) => (
          ...
          {myTests.length === 0 && (
            <HelperText>
              {t("arenaShared.createBattle.emptyTests")}
            </HelperText>
          )}
        </Section>

        <Section>
          <Label>{t("arenaShared.createBattle.visibility")}</Label>
          <VisibilityToggle>
            <VisibilityOption
            ...
            >
              <Globe size={24} />
              <span>{t("arenaShared.createBattle.public")}</span>
            </VisibilityOption>
            <VisibilityOption
            ...
            >
              <EyeOff size={24} />
              <span>{t("arenaShared.createBattle.unlisted")}</span>
            </VisibilityOption>
          </VisibilityToggle>
        </Section>
        ...
        <InfoBox>
          <Info size={16} />
          {visibility === "public"
            ? t("arenaShared.createBattle.publicInfo")
            : t("arenaShared.createBattle.unlistedInfo")}
        </InfoBox>
        ...
        >
          <Play size={18} fill="white" /> {t("arenaShared.createBattle.create")}
        </CreateButton>
      </Content>
    </Overlay>
  );
