...
import { Phone, PhoneOff, Mic, MicOff, Video, VideoOff, Monitor, MonitorOff, MessageSquare, X, Users, Settings } from 'lucide-react'
...
const VideoCall = ({ isOpen, onClose, user }) => {
  ...
  const [participants, setParticipants] = useState([
    { id: 1, name: user || 'Alice', isSpeaking: false, isMuted: false, hasVideo: true },
    { id: 2, name: 'Bob', isSpeaking: false, isMuted: true, hasVideo: false },
    { id: 3, name: 'Charlie', isSpeaking: true, isMuted: false, hasVideo: true }
  ])
