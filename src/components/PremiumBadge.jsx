...
// Option 1: Inline SVG directly (the requested Twitter-like blue verified tick)
const BadgeIcon = ({ width = 20, height = 20, color = "#1d9bf0" }) => (
  <svg
    width={width}
    height={height}
    viewBox="0 0 24 24"
...
const PremiumBadge = ({ width, height, color }) => {
  return <BadgeIcon width={width} height={height} color={color} />;
};
